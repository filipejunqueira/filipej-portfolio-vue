<template>
  ...
  >
    <Container size="sm" class="space-y-5">
      <TextSecondary
        v-for="(paragraph, index) in aboutMeNarrative"
        :key="index"
        as="p"
        v-motion
        ...
        class="text-base md:text-lg leading-relaxed text-center md:text-left"
      >
        {{ paragraph }}
      </TextSecondary>
    </Container>
...
import { Container, TextSecondary } from './UI'
